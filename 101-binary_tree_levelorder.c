 ...
 *
 * Return: If an error occurs, NULL. Otherwise a pointer to the
 * new node
 */
...
/**
 * pint_push - Function that runs function on a given binary trees
 * node and pushes its children into a levelorder_queue_t queue.
